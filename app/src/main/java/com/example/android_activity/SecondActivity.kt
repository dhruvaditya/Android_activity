...
class SecondActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val num=Integer.parseInt(number)// converting the string into integer to perform multiplication
        //this is used for reflecting the data on the second page
        textViewSecond.text="Received number is :"+number
        btn_second.setOnClickListener {
            val result = num * 2 // Calculate the result by multiplying the received number by 2
